...
def DubinsPathDistance(path_array=None):
    path_size = path_array.shape
        
    dist_ = 0
    for i in range(1,path_size[0]):
        dist_ = dist_ + sqrt( pow(path_array[i][0]-path_array[i-1][0],2) + pow(path_array[i][1]-path_array[i-1][1],2) + pow(path_array[i][2]-path_array[i-1][2],2) )
